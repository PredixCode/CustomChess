...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Same defaults as desktop App.currentConfig (no special rules enabled)
        ...
        val board: Board = Board.fromFen(STANDARD_FEN)
        val rules: List<Rule> = RuleBuilder.buildRules(config)
